...
@WebServlet("/forum/submit.do")
@MultipartConfig(location = "", fileSizeThreshold = 5 * 1024 * 1024, maxFileSize = 1024 * 1024
		* 500, maxRequestSize = 1024 * 1024 * 500 * 5)
public class SaveDiscussionServlet extends HttpServlet {
...
//		---------------------------------------------------
		...
		Discussion dis = new Discussion(null, title, content, postTime, author, coverImage, coverImageName, deadline, null);
		Integer discussionId = ds.saveDiscussion(dis);
//		---------------------------------------------------

		
		// 5. 轉到頁面
		String newpage = "discussion?d=" + discussionId;
